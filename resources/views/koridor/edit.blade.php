    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="koridor" method="POST" action="<?= url('admin/koridor/update/'. $koridor->id.'') ?>" enctype="multipart/form-data">
            ...
            <div class="card-footer">
                ...
                <button form="koridor" type="submit" class="btn btn-primary">Perbarui data</button>
            </div>
        </div>
    </div>
</div>
